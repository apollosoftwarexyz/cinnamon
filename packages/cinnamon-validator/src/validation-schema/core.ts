 ...
 * sub-schema) entries.
 */
export type ValidationSchemaArray = [ValidationSchemaField | ValidationSchemaArray | ValidationSchemaObject] | [];
...
export interface ValidationSchemaObject {
    [key: string]: ValidationSchemaField | ValidationSchemaArray | ValidationSchemaObject;
}
 ...
 */
export type ValidationSchema = ValidationSchemaField | ValidationSchemaArray | ValidationSchemaObject;
