 ...
 * @Core
 */
export declare abstract class CinnamonModule extends CinnamonSdkBase {
    /**
    ...
    terminate(inErrorState: boolean): void;
}
export declare abstract class CinnamonOptionalCoreModuleStub extends CinnamonModule {
    /**
...
export declare abstract class CinnamonOptionalCoreModule extends CinnamonOptionalCoreModuleStub {
    get __isStub(): boolean;
    get __stubIdentifier(): string;
    get __stubForModule(): undefined;
}
